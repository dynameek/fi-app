<?php
     ...
     *
    */
    //namespace EasePHP\Database;
    
    class Database
    {
        private const host = 'localhost';
        private const user = 'nate';
        private const pass = 'nathaneil.0110';
        ...
        {
            $this->handle = mysqli_connect(self::host, self::user, self::pass);
        }
        ...
        */
        public function fetchData($table = '', $fields = [], $constraints = [], $constraintLevel = 'tight')
        {
            ...
            else
            {
                ...
                $fieldString = rtrim(trim($fieldString), ','); #  Removing any trailing commas(,)
                ...
                if(!$query_run) $this->dbError = mysqli_error($this->handle);
                else
                {
